...
def _write_root_research_manifest(root: Path) -> None:
    rows = [
        ...
        {"key": "strategy_contract_version", "value": "base_strategy_v2_structural_execution", "source": "strategy_registry"},
...
def _write_valid_minimal_forensic_fixture(root: Path) -> None:
    ...
    _write_artifact(
        ...
        "strategy_trade_simulation.csv",
        {
            ...
            "stop_trigger": "close_beyond",
            "target_trigger": "touch",
            "target_close_fraction": 1.0,
            "stop_distance": 2.0,
            "target_distance": 3.0,
            "stop_price": 98.0,
            "final_stop_price": 98.0,
            "target_price": 103.0,
            "target_was_hit": "True",
            "target_hit_time_ms": 1_920_000,
            "fee_bps": 4.0,
            "slippage_bps": 2.0,
            "cost_model": ROUND_TRIP_COST_MODEL,
            "total_cost": 0.08119976,
            "funding_cost": 0.0,
            ...
            "gross_pnl": 2.9594,
            "net_pnl": 2.87820024,
            "net_pnl_r": 1.43910012,
            "net_return": 0.0287762476,
        ...
        [
            {
                "simulation_version": "mvp1_trade_simulation_pessimistic_v1",
                "target_horizon_minutes": 30,
                "execution_variant_id": "long_running_low_close_then_swing_low_trail::long_partial_at_running_high::close_fraction=1",
                "stop_policy_id": "long_running_low_close_then_swing_low_trail",
                "target_policy_id": "long_partial_at_running_high",
                "target_close_fraction": 1.0,
