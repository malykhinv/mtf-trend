        ...
        profiles = [
            {
                ...
                "seed_min_htf_quote_ratio": 5.0,
                "seed_min_htf_trade_ratio": 5.0,
                "seed_min_htf_return_pct": 0.0100,
                "seed_min_htf_range_pct": 0.0,
                "seed_min_dormancy_to_anomaly_quote_ratio": 0.0,
                "seed_min_dormancy_to_anomaly_trade_ratio": 0.0,
                "seed_max_dormancy_range_pct_median": 1.0,
                "seed_min_abs_quote_volume": 0.0,
                "seed_min_abs_number_of_trades": 0.0,
            ...
            index_rows.append(
                {
                    ...
                    "data_access_model": (
                        "rolling_pair_safe_superset_then_exact_ltf_replay"
    ...
    def _run() -> int:
        ...
        runner = AnomalyLive2Runner(
            AnomalyLive2Config(
                ...
                decision_timeframe_ms=30_000,
                decision_timeframes_ms=(15_000, 30_000),
                ...
                startup_htf_baseline_lookback_minutes=int(getattr(args, "startup_htf_baseline_lookback_minutes", 2880)),
                rolling_context_maintenance_enabled=bool(getattr(args, "rolling_context_maintenance_enabled", True)),
                rolling_context_maintenance_poll_interval_seconds=float(getattr(args, "rolling_context_maintenance_poll_interval_seconds", 10.0)),
                rolling_context_maintenance_symbol_cooldown_seconds=float(getattr(args, "rolling_context_maintenance_symbol_cooldown_seconds", 60.0)),
                rolling_context_maintenance_lookback_minutes=int(getattr(args, "rolling_context_maintenance_lookback_minutes", 720)),
                rolling_context_maintenance_max_symbols_per_cycle=int(getattr(args, "rolling_context_maintenance_max_symbols_per_cycle", 8)),
                rolling_context_maintenance_request_sleep_seconds=float(getattr(args, "rolling_context_maintenance_request_sleep_seconds", 0.02)),
                rolling_context_maintenance_active_symbol_ttl_ms=int(getattr(args, "rolling_context_maintenance_active_symbol_ttl_ms", 60_000)),
                rolling_context_maintenance_closed_candle_lag_ms=int(getattr(args, "rolling_context_maintenance_closed_candle_lag_ms", 5_000)),
                ...
                top_growth_symbols_per_cycle=int(getattr(args, "top_growth_symbols_per_cycle", 16)),
                top_growth_max_cycle_seconds=float(getattr(args, "top_growth_max_cycle_seconds", 3.0)),
                ...
                position_supervisor_tp1_close_fraction=float(getattr(args, "position_supervisor_tp1_close_fraction", 0.75)),
