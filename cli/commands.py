    ...
    def _run() -> int:
        ...
        runner = AnomalyLive2Runner(
            AnomalyLive2Config(
                ...
                oi_stale_ms=int(getattr(args, "oi_stale_ms", 180_000)),
                ...
                oi_max_symbols_per_cycle=int(getattr(args, "oi_max_symbols_per_cycle", 8)),
                oi_radar_symbol_ttl_ms=int(getattr(args, "oi_radar_symbol_ttl_ms", 60_000)),
                prior_context_stale_ms=int(getattr(args, "prior_context_stale_ms", 900_000)),
                prior_context_poll_interval_seconds=float(getattr(args, "prior_context_poll_interval_seconds", 10.0)),
                prior_context_symbol_cooldown_seconds=float(getattr(args, "prior_context_symbol_cooldown_seconds", 300.0)),
                prior_context_lookback_hours=int(getattr(args, "prior_context_lookback_hours", 24)),
                prior_context_max_symbols_per_cycle=int(getattr(args, "prior_context_max_symbols_per_cycle", 4)),
