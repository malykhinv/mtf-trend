...
def build_parser() -> argparse.ArgumentParser:
    ...
    anomaly_live2.add_argument("--rolling-context-maintenance-lookback-minutes", type=_positive_int_for("--rolling-context-maintenance-lookback-minutes"), default=180)
