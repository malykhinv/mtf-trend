...
def build_parser() -> argparse.ArgumentParser:
    ...
    anomaly_lab.add_argument("--max-baseline-return-range-pct", type=float, default=0.12)
    anomaly_lab.add_argument("--max-baseline-close-return-range-pct", type=float, default=0.08)
    ...
    anomaly_live.add_argument("--max-baseline-return-range-pct", type=float, default=0.12)
    anomaly_live.add_argument("--max-baseline-close-return-range-pct", type=float, default=0.08)
