...
def build_parser() -> argparse.ArgumentParser:
    ...
    anomaly_live2.add_argument("--execution-order-notional-usdt", type=float, default=12.0, help="Legacy minimum notional floor; live2 rolling entries are sized by risk.")
    anomaly_live2.add_argument("--execution-risk-per-trade-pct", type=float, default=0.02)
