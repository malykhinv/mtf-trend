...
PINBAR_MAX_BODY_PCT = 35.0
PINBAR_MIN_LOWER_WICK_PCT = 40.0
PINBAR_MAX_UPPER_WICK_PCT = 25.0
MIN_RR = 0.0  # TODO: подобрать оптимальное значение
MIN_TREND_STRENGTH = 0.0
COUNTERTREND_ONLY = False
...
ANOMALY_MIN_GROWTH_PCT = 3
ANOMALY_MIN_ATR_MULT = 3
