...
class Live2DecisionRecord:
    ...
    def as_decision_ledger_row(self) -> dict[str, object] | None:
        ...
        return {
            ...
            "core_signal_verdict": self.signal_features.get("core_signal_verdict", self.signal_verdict),
            "core_signal_reason": self.signal_features.get("core_signal_reason", ""),
            "trade_policy_id": self.signal_features.get("trade_policy_id", ""),
            "trade_policy_version": self.signal_features.get("trade_policy_version", ""),
            "trade_policy_verdict": self.signal_features.get("trade_policy_verdict", ""),
            "trade_policy_reason": self.signal_features.get("trade_policy_reason", ""),
            "trade_policy_rule_id": self.signal_features.get("trade_policy_rule_id", ""),
            "trade_policy_matched_rule_ids": self.signal_features.get("trade_policy_matched_rule_ids", ""),
            "trade_policy_watchlist_rule_ids": self.signal_features.get("trade_policy_watchlist_rule_ids", ""),
            "exit_policy_id": self.signal_features.get("exit_policy_id", ""),
            "exit_tp1_r": self.signal_features.get("exit_tp1_r", ""),
            "exit_tp1_close_fraction": self.signal_features.get("exit_tp1_close_fraction", ""),
            "exit_runner_fraction": self.signal_features.get("exit_runner_fraction", ""),
            "exit_trail_model": self.signal_features.get("exit_trail_model", ""),
            ...
            "htf_ltf_sustained_flow_ok": self.signal_features.get("htf_ltf_sustained_flow_ok", ""),
            "htf_ltf_quote_top1_share": self.signal_features.get("htf_ltf_quote_top1_share", ""),
            "htf_ltf_trade_top1_share": self.signal_features.get("htf_ltf_trade_top1_share", ""),
            "htf_ltf_quote_acceleration": self.signal_features.get("htf_ltf_quote_acceleration", ""),
            "htf_ltf_trade_acceleration": self.signal_features.get("htf_ltf_trade_acceleration", ""),
            "htf_ltf_tail_quote_share": self.signal_features.get("htf_ltf_tail_quote_share", ""),
            "htf_ltf_tail_trade_share": self.signal_features.get("htf_ltf_tail_trade_share", ""),
            "htf_ltf_tail_green_share": self.signal_features.get("htf_ltf_tail_green_share", ""),
            ...
            "pregrowth_min_single_return_pct": self.signal_features.get("pregrowth_min_single_return_pct", ""),
            "pregrowth_min_path_return_pct": self.signal_features.get("pregrowth_min_path_return_pct", ""),
            "pregrowth_range_pct": self.signal_features.get("pregrowth_range_pct", ""),
            "pregrowth_positive_step_share": self.signal_features.get("pregrowth_positive_step_share", ""),
            "pre_seed_dump_rebound_ok": self.signal_features.get("pre_seed_dump_rebound_ok", ""),
