        ...
        rows.append(
            {
                ...
                "hold_count_model": "quote_trade_confirmation_hold",
                "flow_hold_count_next_n_candles": hold_count,
                "flow_hold_ratio_next_n_candles": _safe_divide(hold_count, config.confirmation_candles),
                "price_retention_next_n": price_retention,
                "price_retention_model": "decision_close_vs_impulse_low_to_high",
