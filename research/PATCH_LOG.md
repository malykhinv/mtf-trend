...
| P030 | Replace runtime log filters with source logs | PROPOSED | `utils/logger.py`, `cli/commands.py`, `research/*` | logging/refactor | Удалить глобальный RuntimeNoiseFilter/whitelist и исправить шумные runtime logs в конкретных источниках. | `python -m compileall utils/logger.py cli/commands.py research/PATCH_LOG.md research/RESEARCH_STATE.md` |
