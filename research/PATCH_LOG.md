...
| P031 | Finish source-level runtime logs | PROPOSED | `cli/commands.py`, `research/*` | logging/refactor | Добить оставшиеся runtime источники: wrapper start/path в debug, diagnostics/charts в нормальный человекочитаемый статус. | `python -m compileall cli/commands.py research/PATCH_LOG.md research/RESEARCH_STATE.md` |
