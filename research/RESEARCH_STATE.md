...
- Runtime artifacts from previous local proofs were cleaned from `.output\results` and `tmp`; the source cache `.output\market` was preserved. Local C: free space after cleanup was about `91.8GB`.
