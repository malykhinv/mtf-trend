...
- Data-source boundary is still `PARTIAL` until full 380d all-symbol Binance Vision cache/export validation is recorded with `cache_export_coverage.csv` and `cache_export_manifest.json`.
