...
def _exit_templates() -> tuple[ExitTemplate, ...]:
    return (
        ...
        ExitTemplate(
            template_id="p15_25_be_prevbar",
            label="Take 25% at 1.5R, BE, trail prev bar low",
            hold_minutes=120,
            partial_rr=1.5,
            partial_fraction=0.25,
            move_stop_to_be_after_partial=True,
        ...
        ExitTemplate(
            template_id="p15_35_be_prevbar",
            label="Take 35% at 1.5R, BE, trail prev bar low",
            hold_minutes=120,
            partial_rr=1.5,
        ...
        ExitTemplate(
            template_id="p15_25_be_lastred",
            label="Take 25% at 1.5R, BE, trail last red low",
            hold_minutes=120,
            partial_rr=1.5,
            partial_fraction=0.25,
            move_stop_to_be_after_partial=True,
        ...
        ExitTemplate(
            template_id="p15_35_be_lastred",
            label="Take 35% at 1.5R, BE, trail last red low",
            hold_minutes=120,
            partial_rr=1.5,
            partial_fraction=0.35,
            move_stop_to_be_after_partial=True,
        ...
        ExitTemplate(
            template_id="p20_25_be_prevbar",
            label="Take 25% at 2R, BE, trail prev bar low",
            hold_minutes=120,
            partial_rr=2.0,
            partial_fraction=0.25,
            move_stop_to_be_after_partial=True,
        ...
        ExitTemplate(
            template_id="p20_35_be_prevbar",
            label="Take 35% at 2R, BE, trail prev bar low",
            hold_minutes=120,
            partial_rr=2.0,
            partial_fraction=0.35,
            move_stop_to_be_after_partial=True,
        ...
        ExitTemplate(
            template_id="p20_25_be_lastred",
            label="Take 25% at 2R, BE, trail last red low",
            hold_minutes=120,
            partial_rr=2.0,
            partial_fraction=0.25,
            move_stop_to_be_after_partial=True,
