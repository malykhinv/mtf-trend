...
def build_hourly_asia_pump_trade_models() -> list[HourlyAsiaPumpTradeModel]:
    return [
        ...
        HourlyAsiaPumpTradeModel(
            model_id="context_monster_5pct",
            label="Context Monster 5pct",
            entry_style="break_trigger_high",
            trail_style="last_red_low",
            initial_stop_style="trigger_low",
            min_trigger_return_pct=0.05,
            ...
            fast_fail_bars=2,
            fast_fail_min_return_pct=0.012,
            max_hold_minutes=720,
            max_pre_base_range_pct_60m=0.055,
            max_pre_base_drift_pct_60m=0.03,
            max_pre_base_range_vs_trigger=0.75,
            max_pre_entry_pullback_frac=0.55,
            max_pre_entry_red_volume_frac=0.9,
            min_pre_entry_low_frac_of_trigger_range=0.25,
        ),
        HourlyAsiaPumpTradeModel(
            model_id="context_monster_5pct_tight",
            label="Context Monster 5pct Tight",
            entry_style="break_trigger_high",
            trail_style="last_red_low",
            initial_stop_style="trigger_low",
            min_trigger_return_pct=0.05,
            ...
            fast_fail_min_return_pct=0.012,
            max_hold_minutes=720,
            max_pre_base_range_pct_60m=0.045,
            max_pre_base_drift_pct_60m=0.02,
            max_pre_base_range_vs_trigger=0.6,
            max_pre_entry_pullback_frac=0.4,
            max_pre_entry_red_volume_frac=0.75,
            min_pre_entry_low_frac_of_trigger_range=0.4,
        ),
        HourlyAsiaPumpTradeModel(
            model_id="context_monster_7p5pct",
            label="Context Monster 7.5pct",
            entry_style="break_trigger_high",
            trail_style="last_red_low",
            initial_stop_style="trigger_low",
            min_trigger_return_pct=0.075,
            ...
            min_pre_entry_low_frac_of_trigger_range=0.35,
        ),
        HourlyAsiaPumpTradeModel(
            model_id="context_monster_7p5pct_mid",
            label="Context Monster 7.5pct Mid",
            entry_style="break_trigger_high",
            trail_style="last_red_low",
            initial_stop_style="trigger_low",
            min_trigger_return_pct=0.075,
            ...
            fast_fail_min_return_pct=0.015,
            max_hold_minutes=720,
            max_pre_base_range_pct_60m=0.06,
            max_pre_base_drift_pct_60m=0.03,
            max_pre_base_range_vs_trigger=0.75,
            max_pre_entry_pullback_frac=0.55,
            max_pre_entry_red_volume_frac=0.9,
            min_pre_entry_low_frac_of_trigger_range=0.3,
        ),
        HourlyAsiaPumpTradeModel(
            model_id="context_monster_7p5pct_tight",
            label="Context Monster 7.5pct Tight",
            entry_style="break_trigger_high",
            trail_style="last_red_low",
            initial_stop_style="trigger_low",
            min_trigger_return_pct=0.075,
