...
_FLOAT_COLUMNS_TO_FORMAT = {
    ...
    "best_ppa_median_aggression_ratio_threshold",
    "best_ppa_median_aggression_volume_threshold",
    "best_ppa_median_oi_delta",
    "best_ppa_median_oi_delta_pct",
    "best_ppa_median_entry_minute_of_hour",
    ...
    "median_aggression_ratio_threshold",
    "median_aggression_volume_threshold",
    "median_oi_delta",
    "median_oi_delta_pct",
    "median_entry_minute_of_hour",
    ...
    "oi_available_rate",
    "oi_supportive_rate",
    "entry_on_1m_boundary_rate",
    "entry_on_5m_boundary_rate",
    "entry_on_30m_boundary_rate",
    "entry_on_60m_boundary_rate",
    "range_mid_hit_rate",
    "range_high_hit_rate",
    "tp1_hit_rate",
    "tp2_hit_rate",
    ...
    for run in runs:
        ...
        if best_row is not None:
            for source_column, target_column in (
                ...
                ("ppa_median_aggression_ratio_threshold", "best_ppa_median_aggression_ratio_threshold"),
                ("ppa_median_aggression_volume_threshold", "best_ppa_median_aggression_volume_threshold"),
                ("ppa_median_oi_delta", "best_ppa_median_oi_delta"),
                ("ppa_median_oi_delta_pct", "best_ppa_median_oi_delta_pct"),
                ("ppa_median_entry_minute_of_hour", "best_ppa_median_entry_minute_of_hour"),
                ...
                ("ppa_oi_available_count", "best_ppa_oi_available_count"),
                ("ppa_oi_supportive_count", "best_ppa_oi_supportive_count"),
                ("ppa_entry_on_1m_boundary_count", "best_ppa_entry_on_1m_boundary_count"),
                ("ppa_entry_on_5m_boundary_count", "best_ppa_entry_on_5m_boundary_count"),
                ("ppa_entry_on_30m_boundary_count", "best_ppa_entry_on_30m_boundary_count"),
                ("ppa_entry_on_60m_boundary_count", "best_ppa_entry_on_60m_boundary_count"),
        ...
        rows.append(
            {
                ...
                "median_aggression_ratio_threshold": _median_metric(group, "aggression_ratio_threshold"),
                "median_aggression_volume_threshold": _median_metric(group, "aggression_volume_threshold"),
                "median_oi_delta": _median_metric(group, "oi_delta"),
                "median_oi_delta_pct": _median_metric(group, "oi_delta_pct"),
                "median_entry_minute_of_hour": _median_metric(group, "entry_minute_of_hour"),
                ...
                "oi_available_rate": _hit_rate(group, "oi_available"),
                "oi_supportive_rate": _hit_rate(group, "oi_supportive"),
                "entry_on_1m_boundary_rate": _hit_rate(group, "entry_on_1m_boundary"),
                "entry_on_5m_boundary_rate": _hit_rate(group, "entry_on_5m_boundary"),
                "entry_on_30m_boundary_rate": _hit_rate(group, "entry_on_30m_boundary"),
                "entry_on_60m_boundary_rate": _hit_rate(group, "entry_on_60m_boundary"),
    ...
    lines: list[str] = [
        ...
        _frame_to_markdown(
            ...
            columns=(
                ...
                "best_ppa_oi_available_count",
                "best_ppa_oi_supportive_count",
            ),
        ),
        "",
        "## Trade Summary",
...
def build_post_pump_absorption_research_artifacts(
    *,
    ...
    _plot_bar_grid(
        trade_summary,
        metrics=(
            ("oi_available_rate", "OI Available Rate"),
            ("oi_supportive_rate", "OI Supportive Rate"),
            ("entry_on_5m_boundary_rate", "Entry on 5m Boundary"),
            ("entry_on_30m_boundary_rate", "Entry on 30m Boundary"),
            ("entry_on_60m_boundary_rate", "Entry on 60m Boundary"),
            ("median_entry_minute_of_hour", "Median Entry Minute"),
        ),
        path=charts_dir / "context_markers_by_timeframe.png",
        title="Context Markers by Timeframe",
    )
