...
MVP1_ARTIFACT_SCHEMAS: dict[str, ArtifactSchema] = {
    ...
    "anomaly_decision_timing.csv": ArtifactSchema(
        ...
        description="Decision-timing rows with pre-simulation expected value from calibrated OOS probabilities, ATR distances, fees, and slippage; not realized PnL.",
    ),
    ...
    "anomaly_trade_simulation.csv": ArtifactSchema(
        ...
        description="Simplified pessimistic trade simulation rows after OOS calibration and decision timing; not live execution.",
    ),
    "anomaly_trade_simulation_metrics.csv": ArtifactSchema(
        ...
        description="Aggregate diagnostics for simplified pessimistic trade simulation.",
    ),
