...
MVP1_ARTIFACT_SCHEMAS: dict[str, ArtifactSchema] = {
    ...
    "anomaly_barrier_outcomes.csv": ArtifactSchema(
        name="anomaly_barrier_outcomes.csv",
        stage="mvp1_labels",
        required_columns=(
        ...
        description="Realized next-open structural barrier outcomes for future utility modeling; label artifact only, not a model feature or decision rule.",
    ),
...
STRATEGY_ARTIFACT_ALIASES: dict[str, str] = {
    ...
    "anomaly_barrier_outcomes.csv": "strategy_barrier_outcomes.csv",
