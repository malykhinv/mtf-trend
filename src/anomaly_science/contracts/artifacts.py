...
MVP1_ARTIFACT_SCHEMAS: dict[str, ArtifactSchema] = {
    ...
    "anomaly_nature_atlas.csv": ArtifactSchema(
        ...
        description="Descriptive anomaly nature atlas by as-of relative feature bins and ATR-normalized future response bins.",
    ),
    "anomaly_context_splits.csv": ArtifactSchema(
        ...
        description="Descriptive context splits; grouping columns are as-of feature/state bins and outcomes are ATR-normalized.",
    ),
    "anomaly_response_surfaces.csv": ArtifactSchema(
        ...
        description="Descriptive response surfaces over relative feature bins and ATR-normalized future outcomes.",
    ),
    "anomaly_market_shock_groups.csv": ArtifactSchema(
        ...
        required_columns=(
            ...
            "mean_current_return_from_start",
            "mean_future_return_atr_30m",
            "dominant_outcome_bin",
            "temporal_contract",
        ),
        description="Market-shock groups keyed by point-in-time market_shock_id/systemic_cluster_regime.",
    ),
