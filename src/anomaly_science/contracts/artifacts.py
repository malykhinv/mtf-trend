...
MVP1_ARTIFACT_SCHEMAS: dict[str, ArtifactSchema] = {
    ...
    "anomaly_feature_matrix.csv": ArtifactSchema(
        ...
        description="As-of feature matrix for price path, speed-normalized time, volume, OI, liquidation, CVD, point-in-time cross-sectional, BTC-relative, and systemic cluster features; no future outcomes.",
    ),
