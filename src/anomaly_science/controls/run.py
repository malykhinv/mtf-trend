    ...
    *,
    ...
    written.extend(
        write_csv_artifact_with_aliases(
            output_path / "strategy_placebo_tests.csv",
            placebo_test_rows_to_artifact(placebo_rows),
            get_artifact_schema("strategy_placebo_tests.csv"),
        )
    )
    written.extend(
        write_csv_artifact_with_aliases(
            output_path / "strategy_baseline_comparison.csv",
            baseline_comparison_rows_to_artifact(baseline_rows),
            get_artifact_schema("strategy_baseline_comparison.csv"),
        )
    )
    written.extend(
        write_csv_artifact_with_aliases(
