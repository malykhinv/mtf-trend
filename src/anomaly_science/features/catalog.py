...
def build_default_feature_catalog() -> tuple[FeatureCatalogRow, ...]:
    ...
    rows: list[FeatureCatalogRow] = [
        ...
        _row(
            ...
            model=True,
            missing=FeatureMissingPolicy.NULL_IF_SOURCE_MISSING,
            description="Cumulative taker buy quote minus taker sell quote since event start, normalized downstream by quote volume.",
        ),
        _row(
            ...
            model=True,
            missing=FeatureMissingPolicy.NULL_IF_SOURCE_MISSING,
            description="Five-minute normalized price change minus normalized CVD change.",
        ),
        _row(
        ...
        _row(
            ...
            model=True,
            missing=FeatureMissingPolicy.NULL_IF_SOURCE_MISSING,
            description="Point-in-time cross-sectional rank percentile of volume among eligible symbols.",
        ),
        _row(
            ...
            model=True,
            missing=FeatureMissingPolicy.NULL_IF_SOURCE_MISSING,
            description="Point-in-time cross-sectional rank percentile of 1m return.",
        ),
        _row(
