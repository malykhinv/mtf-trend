"""Strategy-neutral causal projection of raw aggTrades into minute data."""
...
AGGTRADES_MINUTE_SCHEMA_VERSION = "binance_aggtrades_minute_v1"

AGGTRADES_MINUTE_FEATURES: tuple[str, ...] = (
...
def build_minute_aggtrades_features(
    *,
    ...
    if count == 0:
        return pd.DataFrame(columns=("timestamp", *AGGTRADES_MINUTE_FEATURES))
...
__all__ = [
    "AGGTRADES_MINUTE_FEATURES",
    "AGGTRADES_MINUTE_SCHEMA_VERSION",
