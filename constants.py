...
DEFAULT_SPREAD = 0.0
DEFAULT_POSITION_DEPOSIT = 1000.0
DEFAULT_POSITION_RISK_PCT = 0.02
TP1_CLOSE_RATIO = 0.5
...
# CLI defaults
DEFAULT_TOP_N = 50
DEFAULT_COMMANDS_BASE_DAYS = 30
DEFAULT_FETCH_DAYS = DEFAULT_COMMANDS_BASE_DAYS
DEFAULT_UPDATE_DAYS = DEFAULT_COMMANDS_BASE_DAYS
DEFAULT_ANOMALY_LAB_DAYS = DEFAULT_COMMANDS_BASE_DAYS
DEFAULT_HOURLY_LEVELS_DAYS = DEFAULT_COMMANDS_BASE_DAYS
