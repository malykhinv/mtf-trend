...
MTF_PROFILE_1_1: MTFProfile = MTFProfile(macro=Timeframe.D1, context=Timeframe.M30, setup=Timeframe.M1, entry=Timeframe.M1)
MTF_PROFILE_3_1: MTFProfile = MTFProfile(macro=Timeframe.D1, context=Timeframe.M30, setup=Timeframe.M3, entry=Timeframe.M1)
MTF_PROFILE_3_3: MTFProfile = MTFProfile(macro=Timeframe.D1, context=Timeframe.H1, setup=Timeframe.M3, entry=Timeframe.M3)
MTF_PROFILE_5_3: MTFProfile = MTFProfile(macro=Timeframe.D1, context=Timeframe.H1, setup=Timeframe.M5, entry=Timeframe.M3)
MTF_PROFILE_5_1: MTFProfile = MTFProfile(macro=Timeframe.D1, context=Timeframe.H1, setup=Timeframe.M5, entry=Timeframe.M1)

FLOAT_UNDEFINED: float = 0.0

MIN_BARS_BETWEEN_SWINGS: int = 3
MAX_RANGE_SIZE_PCT: int = 100
MAX_CORRECTION_PCT: int = 75
MAX_CORRECTION_BAR_SIZE_FACTOR: int = 2
ACTUAL_CONTEXT_CANDLES: int = 6

# Risk management
VOLUME_THRESHOLD_USDT: int = 5_000_000
MIN_RR: int = 3
PROGRESS_RR_NEAR: int = 1
PROGRESS_RR_FAR: int = 3
MIN_SL_PCT: float = 0.2
MIN_TP_PCT: float = 1.0

PUMP_MIN_MINUTES: int = 20
PUMP_MAX_MINUTES: int = 60 * 6
MIN_PRICE_GROWTH_PCT: int = 3
MIN_ATR_GROWTH_PCT: int = 50
MAX_RANGE_PCT: int = 25
VOLUME_RATIO_MIN: int = 5
...
CANDLE_WIDTH_MULTIPLIER: float = 0.5
